...
<tr>
	...
	<td class=cat>SELECTED ANALYSES</td>
	<td class=cat>(SELECT ANALYSES)</td>
</tr>
...
<td align="right">
<a href="schedule.php?id='.$object->service_no.'" class="app_listitem_key"><IMG SRC="../images/schedule.PNG" ALT="Schedule" height="20" width="60"></A></a>
</td>
</tr>
</table>
</form>
