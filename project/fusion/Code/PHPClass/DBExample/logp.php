...
$link = connectToDB();
  ...
  $strParam="caption=Logging Progress Output report;subCaption=By Sample priority;pieSliceDepth=30; showBorder=1;showNames=1;formatNumberScale=0;numberSuffix= ;decimalPrecision=0";
  ...
  $strQuery = "select b.priority, b.status, count(b.status) as cs from tbllogtaskactivity b  group by b.priority";
