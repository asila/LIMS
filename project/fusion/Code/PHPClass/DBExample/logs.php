...
$link = connectToDB();
  ...
  $strParam="caption=Logging Progress Output report;subCaption=By Sample status;pieSliceDepth=30; showBorder=1;showNames=1;formatNumberScale=0;numberSuffix= ;decimalPrecision=0";
  ...
  $strQuery = "select log.priority, log.status, count(log.status) as cs from tbllogtaskactivity log  group by log.status";
