...
<title>ICRAF-Laboratory Information Management System</title>
<link rel="stylesheet" href="dropdown/dropdown.css" type="text/css" />
<script type="text/javascript" src="dropdown/dropdown.js"></script>
<link href="stylesheets/protec.css" media="all" rel="stylesheet" type="text/css" />
</head>
<body>
<div id="titlebar_m">
	<div id="titlebar_l">
    	<div id="titlebar_r">
			<table border="0" cellpadding="0" cellspacing="0" width="100%" id="titlebar_frame">
				<tr>
					</td><td><a href="../connexion.php"><img src="../default/images/logout.png" width="50" height="50"/></a></td><td><img src="print.jpg" alt="printer" onclick="javascript:window.print();" align="left" height="25" width="25"/><td width="100%" id="system-title">SD4-Laboratory Information Management System</td><td><img src="joomla_black.jpg" alt="logo" name="logo" width="150" height="50" id="logo" /></td>
