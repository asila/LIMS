...
class Database {
	...
	//creation connection function and perform the connection
	...
	//confirm function used in the derived class
  ...
  // adjust record id when new entry is made
