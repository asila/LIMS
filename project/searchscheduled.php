...
<table class="responsive" style="width:100%;">
	<tr align="center">
	<td>
	<a href="../project/scheduled.php"><img SRC="image/back.png" ALT="back" width="40" height="40" ></img></a>
		</td>
...
$query = "select * from scheduled where service_no  is not null $filterstatement";

// execute query
$result = mysql_query($query) or die ("Error in query: $query. ".mysql_error());
 // number of the last column filled
$num_rows = mysql_num_rows($result);
echo '<a href="exposearchscheduled.php?id='.$filterstatement.'" class="app_listitem_key"><IMG SRC="images/searchdownload.JPG" ALT="Download Search" width="30" height="30"></A></a>';	
?>
