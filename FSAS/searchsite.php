...
if (!empty($sitesearch))
{
$filterstatement = $filterstatement . " and Site LIKE '%$sitesearch%' ";
}
...
echo  '<td ><left><span><a href="displaysite.php?id='.$rows['Site'].'">', $rows['Site'],'</a><span></left></td>';
