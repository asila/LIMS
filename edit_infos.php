...
?>
<div class="message">Your informations have successfuly been updated.<br />
...
<div class="content">
    <form action="edit_infos.php" method="post">
        <div class="center">
            ...
            <label for="avatar"><span class="small"></span></label><input type="hidden" name="avatar" id="avatar" value="<?php echo $avatar; ?>" /><br />
...
{
?>
<div class="message">To access LIMS, you must be logged.<br />
<a href="connexion.php">Log in</a></div>
<?php
}
?>
